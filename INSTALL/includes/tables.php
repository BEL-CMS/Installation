...
switch ($_POST['table']) {
	...
	case 'config':
		...
		$insert = "INSERT INTO `".$_SESSION['prefix'].$table."` (`id`, `name`, `value`, `editable`) VALUES
			...
			(NULL, 'CMS_REGISTER_CHARTER', 'En poursuivant votre navigation sur ce site, vous acceptez nos conditions générales d\'utilisation et notamment que des cookies soient utilisés afin de vous connecter automatiquement', '1'),
			('', 'CMS_MAIL_WEBSITE', '".$_SERVER['SERVER_ADMIN']."', '0'),
			('', 'CMS_WEBSITE_KEYWORDS', '', '0'),
			('', 'CMS_WEBSITE_LANG', 'fr', '1'),
			('', 'CMS_LOG', '0', '1'),
            ('', 'CMS_LOG_MAX', '1 MONTH', '1'),
			('', 'CMS_TPL_FULL', 'articles,calendar,comments,downloads,events,forum,groups,inbox,market,members,newsletter,page,shoutbox,survey,team,user,readmore', '0'),
			('', 'CMS_DEBUG', '1', '0'),
			('', 'API_KEY', '".md5(uniqid(rand(), true))."', '0'),
